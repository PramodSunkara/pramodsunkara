    ...
    <section className="min-h-screen flex items-center justify-center section-padding pt-32 relative">
      ...
      <div className="container-narrow text-center relative z-10">
        <div className="relative inline-block">
          ...
          <h1 className="text-hero text-foreground reveal-hero mb-8">
        ...
        <p className="text-body text-muted-foreground max-w-2xl mx-auto mb-16 reveal-hero reveal-delay-1">
        ...
        <Button 
          ...
          className="reveal-hero reveal-delay-2 rounded-full px-8 py-6 text-base bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300"
        >
          View my work
        </Button>

        {/* Value propositions */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-32 reveal-hero reveal-delay-3">
