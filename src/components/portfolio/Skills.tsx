...
const aiTools = [{
  name: 'ChatGPT',
  icon: <svg viewBox="0 0 24 24" className="w-4 h-4 transition-colors" fill="currentColor">
  ...
  name: 'Figma AI',
  icon: <svg viewBox="0 0 38 57" className="w-4 h-4 transition-colors" fill="currentColor">
  ...
  return <section id="skills" className="section-padding">
      <div className="container-narrow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 mb-16">
          {skillCategories.map((category, index) => <div key={category.title} className={`reveal reveal-delay-${index + 1}`}>
              ...
              return <li key={skill.name} className="text-sm text-muted-foreground flex items-center gap-2.5">
        ...
        <div className="reveal reveal-delay-4 border-t border-border pt-12">
          ...
          <div ref={containerRef} className="flex flex-wrap gap-2.5 items-end pb-2" onMouseLeave={() => setHoveredIndex(null)}>
            {aiTools.map((tool, index) => <span key={tool.name} onMouseEnter={() => setHoveredIndex(index)} className="text-sm px-4 py-2 bg-secondary text-foreground rounded-full transition-all duration-200 ease-out hover:bg-primary hover:text-primary-foreground flex items-center gap-2 group cursor-default origin-bottom" style={{
            '--tool-color': tool.color,
            transform: `scale(${getScale(index)}) translateY(${getTranslateY(index)}px)`
          } as React.CSSProperties}>
                <span className="[&>svg]:transition-colors [&>svg]:duration-300 group-hover:[&>svg]:text-primary-foreground" style={{
              color: tool.color
            }}>
                  {tool.icon}
                </span>
            ...
            <div>
              ...
              <ul className="space-y-3 text-base text-muted-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-semibold text-foreground">Google UX Design Professional Certificate, 2026</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-1.5 h-1.5 rounded-full bg-primary mt-2.5 flex-shrink-0"></span>
              ...
              <div className="flex flex-wrap gap-8 mt-6 items-center justify-center md:justify-start">
                <img src={googleUxBadge} alt="Google UX Design Professional Certificate" className="w-28 h-28 md:w-36 md:h-36 object-contain drop-shadow-md" style={{
                imageRendering: 'auto'
              }} />
                <img src={ibmBadge} alt="IBM Generative AI Essentials Certificate" className="w-28 h-28 md:w-36 md:h-36 object-contain drop-shadow-md" style={{
                imageRendering: 'auto'
              }} />
                <img src={w3cxBadge} alt="W3Cx Front End Web Developer Certificate" className="w-28 h-28 md:w-36 md:h-36 object-contain drop-shadow-md" style={{
                imageRendering: 'auto'
              }} />
              </div>
            </div>
