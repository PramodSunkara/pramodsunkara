...
const aiTools = [
  ...
  { 
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4 transition-colors" fill="currentColor">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17.93c-3.95.49-7.44-2.99-6.95-6.95.34-2.76 2.57-4.99 5.33-5.33 3.95-.49 7.44 2.99 6.95 6.95-.34 2.76-2.57 4.99-5.33 5.33zM12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z"/>
      </svg>
    ),
    color: '#20B2AA'
  },
