                ...
                <div className="relative z-10 flex flex-col h-full min-h-[280px]">
                  ...
                  >
                    <Link
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-full font-medium transition-all duration-300 hover:gap-4 hover:shadow-lg hover:shadow-primary/30"
                    >
                      Know More
